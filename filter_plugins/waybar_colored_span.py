...
class FilterModule(object):
    ...
    def waybar_colored_block(
        ...
        if last_block and position == "left":
            return f"""<span size=\\"large\\" background=\\"#{left_color}\\" color=\\"#{left_color}\\"></span><span size=\\"large\\" background=\\"#{left_color}\\" color=\\"#{color}\\"></span><span background=\\"#{color}\\"> {text} </span><span size=\\"large\\" color=\\"#{color}\\"></span>"""
        elif last_block and position == "right":
            return f"""<span size=\\"large\\" background=\\"#{left_color}\\" color=\\"#{left_color}\\"></span><span size=\\"large\\" background=\\"#{left_color}\\" color=\\"#{color}\\"></span><span background=\\"#{color}\\"> {text} </span>"""
        elif last_block:
            raise ValueError(
                f"""If last_block is True a position of 'left' or 'right' must be passed. Given: {position}"""
            )
